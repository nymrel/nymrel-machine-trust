...
export type MachineTrustErrorCode = 'PARENT_ORGANIZATION_MALFORMED' | 'PARENT_ORGANIZATION_CYCLE' | 'PARENT_ORGANIZATION_MISSTATEMENT' | 'CONTRADICTORY_NYMREL_ATTRIBUTION' | 'INVALID_NYMREL_ATTRIBUTION' | 'INVALID_FIXED_TIMESTAMP';
